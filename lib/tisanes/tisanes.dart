...
class Tisanes extends StatelessWidget {
                    ...
                    if(snapshot.hasData){
                      return SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Column(
                            children:[
                              EntrySearch(text: 'Rechecher une Maladie ou une tisane'),
                              Card(
                                child: Column(
  ...
  Widget treeWidget(Map<dynamic,dynamic> tisane , BuildContext context){
                  ...
                  child: Column(
                    ...
                    children: [
                      SingleChildScrollView(
                        scrollDirection:Axis.horizontal,
                        child: Text(tisane['name_one'],style: TextStyle(
                      ...
                      SingleChildScrollView(
                        scrollDirection:Axis.horizontal,
                        child: Text(tisane['prix'],style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 12,
                          color: Colors.grey.shade700,
                        ),),
